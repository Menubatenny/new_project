...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { delivery_address: @detail.delivery_address, pickup_address: @detail.pickup_address } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { delivery_address: @detail.delivery_address, pickup_address: @detail.pickup_address } }
